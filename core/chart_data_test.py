...
class ChartDataTest(unittest.TestCase):
  ...
  def test_can_transform_stats_cluster_with_multiple_values_and_ids_to_chart_data(self):
    ...
    self.assertEqual(1, len(lines_dict['kiril_valuename1'].x_coords()))
    self.assertEqual(1, len(lines_dict['kiril_valuename1'].y_coords()))
    self.assertEqual(str_to_date('17/05/2019'), lines_dict['kiril_valuename1'].x_coords()[0])
    self.assertEqual(2, lines_dict['kiril_valuename1'].y_coords()[0])

    self.assertEqual(1, len(lines_dict['kiril_valuename2'].x_coords()))
    self.assertEqual(1, len(lines_dict['kiril_valuename2'].y_coords()))
    self.assertEqual(str_to_date('17/05/2019'), lines_dict['kiril_valuename2'].x_coords()[0])
    self.assertEqual(20, lines_dict['kiril_valuename2'].y_coords()[0])
