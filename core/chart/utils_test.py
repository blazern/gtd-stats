...
'''
    ...
    appearances = extract_chart_appearances_from_stats_metadata(metadata)
    ...
    self.assertEqual(PeriodChartAppearanceModifier, type(appearance3.modifiers[1]))
    self.assertEqual(PeriodChartAppearanceModifier.Unit.DAY, appearance3.modifiers[1].time_unit)
